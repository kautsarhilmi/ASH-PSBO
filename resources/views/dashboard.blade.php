		...
		<div class="container">
					<div class="leftbar p-r-0 p-r-0-sm">
						...
						<div class="row">
							...
							@foreach ($room->furnitures as $furniture)
							<div class="col-12 text-sm-center col-sm-12 text-md-left col-md-6">
									<h4 class="product-name"><strong>{{$furniture->name}}</strong></h4>
									<h4>
							...
							<div class="col-12 col-sm-12 text-sm-center col-md-4 text-md-right row">
									<div class="col-3 col-sm-3 col-md-6 text-md-right" style="padding-top: 5px">
											<h6><strong>Rp{{$furniture->price}} <span class="text-muted">x</span>{{ $furniture->pivot->quantity }}</strong></h6>
									</div>
